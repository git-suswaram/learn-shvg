...
public class JPrimitiveData {
     ...
     */
    public JPrimitiveData() {
    }

    public JPrimitiveData(String firstName, String lastName, String department) {
        this.firstName = firstName;
        this.lastName = lastName;
        this.department = department;
    }

    public JPrimitiveData(String firstName, String lastName, LocalDate dateOfBirth, String department, String jobTitle, Double netAnnualIncome) {
        this.firstName = firstName;
        this.lastName = lastName;
    ...
    public int compareTo(JPrimitiveData employee) {
    ...
    public boolean equals(Object o) {
        ...
        JPrimitiveData employee = (JPrimitiveData) o;
