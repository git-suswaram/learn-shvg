...
import com.shvg.spring.springboot.test.mockito.exception.EmployeeNotFoundException;
...
public class EmployeeResource {
    ...
    public MappingJacksonValue get() {
        ...
        logger.info("Entered /jpa/employee");
    ...
    public MappingJacksonValue get(@PathVariable int employeeID) {
        ...
        logger.info("Entered /jpa/employee/{employeeID}");
