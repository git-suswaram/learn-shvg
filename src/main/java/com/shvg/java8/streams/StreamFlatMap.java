...
public class StreamFlatMap {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nStream of complex data structure List<List<String>>");
        List<List<String>> nestedNames = Arrays.asList(
                Arrays.asList("Jeff","Bezos"),
                Arrays.asList("Bill","Gates"),
                Arrays.asList("Mark","Zukerberg")
        );
        System.out.println(nestedNames);

        System.out.println("Convert stream of List<List<String>> to List<String> using - flatMap()");
