...
public class StreamMin {
    ...
    public static void main(String[] args) {
        ...
        int minOfElementsOfIntArray = IntStream.of(primitiveIntArrayOfNumbers).min().getAsInt();
        System.out.printf("%n minOfElementsOfIntArray: %d%n",minOfElementsOfIntArray);

        //******************************************************************************************************************

        int minOfElementsOfIntArrayOrElse = IntStream.of(primitiveIntArrayOfNumbers).min().orElse(0);
        System.out.printf("%n minOfElementsOfIntArrayOrElse: %d%n",minOfElementsOfIntArrayOrElse);

        //******************************************************************************************************************

        int minOfElementsOfEmptyArray = IntStream.of(emptyArray).min().orElse(0);
        System.out.printf("%n minOfElementsOfEmptyArray: %d%n",minOfElementsOfEmptyArray);

        //******************************************************************************************************************
        System.out.println("\nGet employee with min salary using - min()");
        System.out.println(
