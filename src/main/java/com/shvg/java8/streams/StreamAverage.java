...
public class StreamAverage {
    ...
    public static void main(String[] args) {
        ...
        double averageOfElementsOfIntArray = IntStream.of(primitiveIntArrayOfNumbers).average().getAsDouble();
        System.out.printf("%n averageOfElementsOfIntArray: %.2f%n",averageOfElementsOfIntArray);

        //******************************************************************************************************************

        double averageOfElementsOfIntArrayOrElse = IntStream.of(primitiveIntArrayOfNumbers).average().orElse(0.0);
        System.out.printf("%n averageOfElementsOfIntArrayOrElse: %.2f%n",averageOfElementsOfIntArrayOrElse);

        //******************************************************************************************************************

        double averageOfElementsOfEmptyArray = IntStream.of(emptyArray).average().orElse(0.0);
        System.out.printf("%n averageOfElementsOfEmptyArray: %.2f%n",averageOfElementsOfEmptyArray);
