...
public class StreamSum {
    ...
    public static void main(String[] args) {
        ...
        int sumOfElementsOfIntArray = IntStream.of(primitiveIntArrayOfNumbers).sum();
        System.out.printf("%n sumOfElementsOfIntArray: %d%n",sumOfElementsOfIntArray);

        //******************************************************************************************************************

        int sumOfElementsOfEmptyArray = IntStream.of(emptyArray).sum();
        System.out.printf("%n sumOfElementsOfEmptyArray: %d%n",sumOfElementsOfEmptyArray);
